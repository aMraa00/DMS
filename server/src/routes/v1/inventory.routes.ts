...
inventoryRouter.get('/', async (req: AuthedRequest, res) => {
  const q = z.object({
...
inventoryRouter.post('/', async (req: AuthedRequest, res) => {
...
inventoryRouter.patch('/:id', async (req: AuthedRequest, res) => {
...
inventoryRouter.delete('/:id', async (req: AuthedRequest, res) => {
