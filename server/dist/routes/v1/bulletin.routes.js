...
bulletinRouter.get('/', async (req, res) => {
    const q = z.object({
        type: z.enum([...BULLETIN_TYPES, 'all']).optional().default('all'),
...
/** Миний зарууд */
bulletinRouter.get('/my', async (req, res) => {
...
/** Шинэ зар нийтлэх */
bulletinRouter.post('/', async (req, res) => {
...
bulletinRouter.delete('/:id', async (req, res) => {
...
//# sourceMappingURL=bulletin.routes.js.map